/* **************************************************************
*****************************************************************
PENMON_GDS.CPP - object computes EET using Penman-Monteith
...
//  cout << "kplant = " << kplant << " " << kha << " " << khb << " " << gstem << " " << stemc << " " << groot[pdcmnt] <<  " " << rootc << " " << kstem[pdcmnt] <<
//" " << rhostem[pdcmnt] << " " << vegh << endl;
...
//cout << "fws = " << fws << " " << lsc << " " << lscmin[pdcmnt] << " " << wfrac << " " << power << " " << pdcmnt << " " << kplant << " " << lai <<endl;
