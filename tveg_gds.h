/** **************************************************************
*****************************************************************
TVEG_GDS.H -  Vegetation characteristics used in the Terrestrial
                Ecosystem Model (TEM)
...
************************************************************** */
     ...
     void setTEMP( const int& pdcmnt, const double& tair, const int& pdyr );
...
// end of allocation get and set methods
     ...
     // cnleaf **************************************************
      ...
      inline double getCNLEAF( const int& pcmnt )
      {
        return cnleaf[pcmnt];
      };
     ...
     // cnroot **************************************************
      ...
      inline double getCNROOT( const int& pcmnt )
      {
        return cnroot[pcmnt];
      };
     ...
     // cnsapwood **************************************************
      ...
      inline double getCNSAPWOOD( const int& pcmnt )
      {
        return cnsapwood[pcmnt];
      };
...
//    BSF added dgppdrootc
    ...
    inline void setNRESORBL( const double& pnresorbl )
     {
       nresorbl = pnresorbl;
     };
...
//  BSF added setSONINPUT
  ...
  inline double getDENITR( void ) { return denitr; };
   ...
   inline void setPHICNT( const double& pphicnt )
   {
     ...
     inline double getKALLOM( const int& pcmnt )
     {
       return kallom[pcmnt];
     };
