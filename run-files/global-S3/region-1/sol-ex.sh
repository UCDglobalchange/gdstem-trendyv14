#!/bin/bash
#SBATCH -J gdstem-run-S3-region-1
#SBATCH --account moniergrp
#SBATCH -e slurm/sterror_%A_%a.txt
#SBATCH -o slurm/stdoutput_%A_%a.txt
#SBATCH --nodes=1
#SBATCH --ntasks=2
...
#SBATCH --mem=6G
#SBATCH -t 48:00:00
#SBATCH --exclude=cpu-3-[50-57,62-69],cpu-4-[68-71,86-93]
...
echo "Launching srun..."
srun --hint=nomultithread -n 2 -c 1 --mpi=none bash -c '
  set -euo pipefail
