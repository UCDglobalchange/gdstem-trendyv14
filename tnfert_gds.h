/* *************************************************************
****************************************************************
TNFERT_GDS.H - determines both potential and "actual" land
...
************************************************************* */
     ...
     int tnfertcropflag;
     string nfertcropfname;
     string nfertcropend;

     FILE* ifnfertpasture;

     int tnfertpastureflag;
     string nfertpasturefname;
     string nfertpastureend;
